#!/usr/bin/env python3
"""Recreate Deadman on AlgoKit LocalNet and write docs/localnet.json.
...
CONTRACT = ROOT / "smart_contracts" / "deadman" / "contract.py"
ARTIFACT_DIR = ROOT / "smart_contracts" / "artifacts" / "deadman"
...
CONTRACT_NAME = "Deadman"
SOURCE = "smart_contracts/deadman/contract.py"
